...
def run_pipeline(decay_rate=0.15, time_decay_const=-0.002, use_normalized_igns=True, include_series_draft_features=True):
    # ==========================================
    # STEP 1: LOAD & CLEAN
    # ==========================================
    ...
    # NEW: Targeted bans against comfort heroes opponent played in the immediately preceding game
    ...
    for index, row in training_df.iterrows():
        ...
        if game_num > 1 and include_series_draft_features:
    ...
    if include_series_draft_features:
        all_features += [
...
if __name__ == "__main__":
    print("🧪 Running Advanced Series Draft Optimization Experiment (Comfort Bans disruption)...")
    
    a1, a2, ac = run_pipeline(decay_rate=0.15, time_decay_const=-0.002, use_normalized_igns=True, include_series_draft_features=True)
